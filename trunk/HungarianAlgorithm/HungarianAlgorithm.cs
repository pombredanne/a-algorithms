...
public static class HungarianAlgorithm
{
    ...
    private static int RunStep1(double[,] costs, byte[,] masks, bool[] rowsCovered, bool[] colsCovered, int w, int h)
    {
        for (int i = 0; i < h; i++)
        {
            for (int j = 0; j < w; j++)
    ...
    private static int RunStep2(double[,] costs, byte[,] masks, bool[] rowsCovered, bool[] colsCovered, int w, int h,
    ...
    private static int RunStep3(double[,] costs, byte[,] masks, bool[] rowsCovered, bool[] colsCovered, int w, int h,
    ...
    private static Location FindZero(double[,] costs, byte[,] masks, bool[] rowsCovered, bool[] colsCovered,
        int w, int h)
    {
        for (int i = 0; i < h; i++)
        {
